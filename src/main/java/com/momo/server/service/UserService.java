...
public class UserService {
    ...
    /*
        username 업데이트 연산
     */
    private ArrayList<String> updateUserNameList(Meet meetEntity, User userEntity, ArrayList<String> userNameList) {
        if (meetEntity.getUsers() == null) {
    ...
    /*
        userId 업데이트 연산
     */
    private ArrayList<BigInteger> updateUserIdList(Meet meetEntity, User userEntity, ArrayList<BigInteger> userList) {
        if (meetEntity.getUsers() == null) {
