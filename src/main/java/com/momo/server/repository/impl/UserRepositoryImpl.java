...
public class UserRepositoryImpl implements UserRepository {
    ...
    public User findUser(SessionUser user) {
        ...
        User userEntity = mongoTemplate.findOne(
            Query.query(Criteria.where("userId").is(user.getUserId())), User.class);
        return userEntity;
    }
    ...
    public void removeUserByUsername(String username) {
        ...
        Query findUserQuery = new Query(Criteria.where("username").is(username));
